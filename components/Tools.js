...
export default function Tools() {
  return (
    <div className="max-w-5xl mx-auto py-10">
      ...
      <div className="col-span-3 md:pr-8 justify-self-end"><Segment /></div>
      <div className="col-span-3 md:pl-8 justify-self-start"><Customerio /></div>

      <div className="col-span-2"><GA /></div>
      <div className="col-span-2"><Amplitude /></div>
      <div className="col-span-2"><Hotjar /></div>

      <div className="col-span-2"><Zapier /></div>
      <div className="col-span-2"><Airtable /></div>
      <div className="col-span-2"><Autocode /></div>

      <div className="col-span-2"><Pipedrive /></div>
      <div className="col-span-2"><Zendesk /></div>
        <div className="col-span-2"><div className="flex flex-inline items-center"><Vitally /><span className="ml-4 font-semibold text-xl">Vitally</span></div></div>

        <div className="col-span-2"><Nextjs /></div>
        <div className="col-span-1"><Github /></div>
        <div className="col-span-1"><Parabola /></div>
        <div className="col-span-1"><Webhooks /></div>

      <div className="col-span-2"><Intercom /></div>
      <div className="col-span-2"><Shopify /></div>
      <div className="col-span-2"><Paddle /></div>
